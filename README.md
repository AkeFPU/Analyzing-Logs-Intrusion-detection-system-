🛡️ Log Analyzer Intrusion Detection System (GUI-Based)

A Python-based GUI Intrusion Detection System (IDS) that analyzes server access logs to detect suspicious login behavior and potential brute-force attacks using time-window correlation and severity analysis.
